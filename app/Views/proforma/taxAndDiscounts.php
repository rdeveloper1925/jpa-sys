...
<div class="row">
	...
	<div class="card mb-4">
		<div class="card-header">
			Proforma Preview (No. <?=$invoiceId?>) LPO No. <?=$data->lpoNo?>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-5">
				...
				<div class="container col-md-12">
                    ...
                    <!--
                    <form action="<?=base_url('proforma/generate/'.$invoiceId)?>" method="post">
                        <input type="hidden" id="words" name="words"/>
                        <button type="submit"  class="btn btn-md btn-success">Generate TAX INVOICE PDF</button><br>
                    </form>-->
                    <form action="<?=base_url('proforma/generate2/'.$invoiceId)?>" method="post">
