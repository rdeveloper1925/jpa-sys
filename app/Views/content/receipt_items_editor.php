    ...
    <div class="col-md-12 container">
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    <form method="post" action="<?=base_url('receipts/update_edits/'.$receiptNo)?>">
                    <div class="row">

                        <div class="form-group col-4">
                            <label for="">Receipt No.</label>
                            <input type="text" class="form-control" name="receiptId" value="<?=$receipt->receiptId?>"  >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Ref No: </label>
                            <input type="text" class="form-control" name="refNo" value="<?=$receipt->refNo?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Account Name: </label>
                            <input type="text" class="form-control" name="accountName"  value="<?=$receipt->accountName?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Narration: </label>
                            <input type="text" class="form-control" name="narration" value="<?=$receipt->narration?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Date: </label>
                            <input type="date" class="form-control" name="date" value="<?=$receipt->date?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Ref Date: </label>
                            <input type="date" class="form-control" name="refDate" value="<?=$receipt->refDate?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Prepared by: </label>
                            <input type="text" class="form-control" value="<?=$receipt->preparedBy?>" >
                        </div>
                        <hr>
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" name="currency" value="<?=$receipt->currency?>" >
                        </div>
                        <div class="form-group col-4">
                            <label for="">Received by: </label>
                            <input type="text" class="form-control" name="receivedBy" value="<?=$receipt->receivedBy?>" >
                        </div>
                    </div>
                </div>
            </div>
